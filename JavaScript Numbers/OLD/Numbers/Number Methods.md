...
toFixed(),number,Fixed decimal places,Yes,Yes
toPrecision(),number,Significant digits,Yes,Yes
valueOf(),number,Returns primitive number value,No,No
Number.isFinite(),Number,Is it a finite number?,—,—
Number.isInteger(),Number,Is it an integer?,—,—
Number.isNaN(),Number,Better/safer check for NaN,—,—
